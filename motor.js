...
var _sim_reset = Module['_sim_reset'] = makeInvalidEarlyAccess('_sim_reset');
var _sim_load_bin = Module['_sim_load_bin'] = makeInvalidEarlyAccess('_sim_load_bin');
var _sim_step = Module['_sim_step'] = makeInvalidEarlyAccess('_sim_step');
var _sim_get_pc = Module['_sim_get_pc'] = makeInvalidEarlyAccess('_sim_get_pc');
var _sim_get_cycle = Module['_sim_get_cycle'] = makeInvalidEarlyAccess('_sim_get_cycle');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['sim_reset'] != 'undefined', 'missing Wasm export: sim_reset');
  assert(typeof wasmExports['sim_load_bin'] != 'undefined', 'missing Wasm export: sim_load_bin');
  assert(typeof wasmExports['sim_step'] != 'undefined', 'missing Wasm export: sim_step');
  assert(typeof wasmExports['sim_get_pc'] != 'undefined', 'missing Wasm export: sim_get_pc');
  assert(typeof wasmExports['sim_get_cycle'] != 'undefined', 'missing Wasm export: sim_get_cycle');
  ...
  _sim_reset = Module['_sim_reset'] = createExportWrapper('sim_reset', 0);
  _sim_load_bin = Module['_sim_load_bin'] = createExportWrapper('sim_load_bin', 2);
  _sim_step = Module['_sim_step'] = createExportWrapper('sim_step', 0);
  _sim_get_pc = Module['_sim_get_pc'] = createExportWrapper('sim_get_pc', 0);
  _sim_get_cycle = Module['_sim_get_cycle'] = createExportWrapper('sim_get_cycle', 0);
